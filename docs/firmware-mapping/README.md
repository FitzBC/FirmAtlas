...
> 文档 ID：FM-MASTER
> 当前阶段：M1 冷启动发现
> 当前状态：M1-11 代表性架构 corpus 出口门进行中；M1-20 X5000R multipart nested dispatch 已验证；当前 gate 为 `partial`
> 最近更新：2026-08-09
